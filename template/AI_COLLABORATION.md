...
[`docs/guia-para-agentes.md`](docs/guia-para-agentes.md) y
[`docs/como-usar-continuum.md`](docs/como-usar-continuum.md). No conviertas
este protocolo en una enciclopedia: mueve el detalle estable a documentación
indexada y léelo bajo demanda.
...
[`docs/trabajo-en-equipo.md`](docs/trabajo-en-equipo.md). Si trabajas
solo/a, sáltate esta sección.
